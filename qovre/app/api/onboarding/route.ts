...
function formatCustomerEmail(d: FormData): { subject: string; text: string } {
  ...
  if (isEN) {
    ...
    const text = [
      ...
      '  2. We prepare a tailored proposal or intake questions',
  ...
  const text = [
    ...
    '',
    'Wat er nu gebeurt:',
    '  1. We beoordelen uw aanvraag binnen 24 uur',
    '  2. We stellen een voorstel of intakevragen op',
    '  3. We nemen contact op via het opgegeven e-mailadres',
    '',
